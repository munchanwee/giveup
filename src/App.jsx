    ...
    return (
      <main className="page intro-page">
        ...
        <section className="hero frame">
          <div className="intro-mark">Giving Up Index</div>
          <h1>포기력 지수</h1>
          <p className="subtitle">나는 어떤 방식으로 포기하는가.</p>
          <p className="note highlight">잘하고 못함을 재는 검사가 아니라, 내가 어디쯤 있는지를 가늠해보는 점검입니다.</p>
          <p className="action-note">16개의 장면을 지나며<br />약 2분 동안 나의 포기력이<br />어떤 형태로 작동하는지 확인합니다.</p>
          <button className="primary-btn" onClick={start}>포기력 확인하기 →</button>
          ...
          <div className="intro-copy">
            ...
            <p>끊는 사람인지 흘려보내는 사람인지,<br />감각을 따르는지 상황을 읽는지,<br />빠르게 결론 내리는지 천천히 확인하는지,<br />끊고 나서 닫히는지 열려 있는지 살펴봅니다.</p>
          </div>
        </section>
      </main>
    );
